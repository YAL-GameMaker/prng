...
#macro DEFAULT_RUN_COUNT        100
#macro DEFAULT_ITERATION_COUNT  1000
...
self.DrawBarChart = function(w, h, mx, my) {
    ...
    switch (obj_main.display_type) {
        case EDisplayTypes.TIME:
            ...
            break;
        case EDisplayTypes.MS_PER_OP:
        	max_value = benchmark_log_ceil(worst_trial.runtime.ms) / obj_main.iteration_count;
        	break;
        case EDisplayTypes.PERCENT:
            // not relevant
            break;
    ...
    for (var i = 0; i < test_count; i++) {
        ...
        switch (obj_main.display_type) {
            case EDisplayTypes.TIME:
                ...
                break;
            case EDisplayTypes.MS_PER_OP:
                y1 = y2 - (bar_finish_y - bar_start_y) * test.runtime.ms / obj_main.iteration_count / max_value;
                break;
            case EDisplayTypes.PERCENT:
